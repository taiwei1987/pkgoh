...
```text
┌ pkgoh ───────────────────────────────────────────────────────────────────────────┐
│ 来源: 全部  排序: 大小 ↓  已选: 2  可释放: 1.4GB  总数: 38                    │
│ 模块: [Homebrew npm pnpm cargo pip uv mas]  搜索: hidden                      │
├───────────────────────────────────┬─────────────────────────────────────────────┤
│ #  名称          来源      版本 大小 │ 详情                                      │
│ 1. hiddenbar     Homebrew  ... 12KB │ 名称: hiddenbar                            │
│ 2. uv            uv        ... 84MB │ 简介: Python 运行时与包管理工具            │
│ 3. pnpm          pnpm      ... 31MB │ 评估建议: 建议保留                         │
│ ...                               │ 评估说明: 其他全局工具可能依赖它            │
├───────────────────────────────────┴─────────────────────────────────────────────┤
│ 操作                                                                          │
│ 删除确认                                                                      │
│ 将删除 2 个选中项，预计释放 1.4GB                                              │
│ 再按一次 Delete 或 Enter 执行，Esc 取消。                                      │
├──────────────────────────────────────────────────────────────────────────────┤
│ ↑↓ 移动  / 搜索  按数字跳转  Space 多选  Delete 删除  C 清缓存                │
│ R 刷新  S 按大小排序  Esc 退出                                                │
└──────────────────────────────────────────────────────────────────────────────┘
```
